    ...
    <React.Fragment>
      {userss?.role === "admin" && (
        <>
          ...
          <li className="li">
            <Link to="/allDoctior">All Doctors</Link>
          </li>
          <li className="li">
      ...
      {userss?.role !== "admin" && (
        <>
          ...
          <li className="li">
            <Link to="/userBooking">User Booking Lisht</Link>
          </li>
        </>
      )}
    ...
    <div className="navbar navsbottom flex justify-between w-[100%] mx-auto fixed top-0 z-50 bg-white">
      <div className="navbar-start">
        ...
        <Link to="/" className="flex ">
          ...
          <h1 className="mt-[34px] ml-0 text-[12px] font-extrabold text-[#3A4255]">
            CLINIC
          </h1>{" "}
        </Link>
      </div>
      <div className="navbar-center hidden lg:flex mr-10">
        ...
        {user?.uid ? (
          <div className="avatar online mr-5">
            <label
              htmlFor="my-modal"
              className=" w-[45px] h-[45px] rounded-full img-border cursor-pointer"
            >

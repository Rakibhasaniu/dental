  ...
  return (
    <>
      <div className="w-[100%] flex justify-center align-middle items-center">
        <form
          className="bg-gradient-to-r from-primary to-secondary lg:w-[385px] rounded-lg  p-10 my-20"
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-2">
            <div className="block">
              ...
              {errors.name && (
                <p
                  role="alert"
                  className="mt-2 ml-1 text-[#ef1010] text-bold text-[13px] "
                >
          ...
          {errors?.password ? (
            <p
              role="alert"
              className=" ml-1 text-[#ef1010] text-bold text-[13px] mt-2"
            >
            ...
            dirtyFields.password && (
              <h1 className="text-[14px] ml-1 mt-2 text-[#87069e]">
                ✅ your password be strong
              </h1>
            )
          )}

          <Link className="label-text ml-[3px] mt-[2px] text-slate-500 hover:text-black">
            forget password
          </Link>

          <input
            className="btn w-full bg-slate-600 text-white mt-6 mx-auto flex justify-center"
            type="submit"
          />
          ...
          <div className="down-text mt-5">
            ...
            <div className="flex gap-5 justify-center">
              <Link className="block">
                ...
                <p className="text-[10px] text-black hover:text-[#0d28c5] text-center">
                  facbook
                </p>
              </Link>
              <Link onClick={autoSingInGoogle} className="block">
                <FaGoogle className="text-2xl text-[#0a0a0a] hover:text-[#0201019e]"></FaGoogle>
                <p className="text-[10px] text-black hover:text-[#0201019e]">
                  google
                </p>
              </Link>
              <Link className="block">
